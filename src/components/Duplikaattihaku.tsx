...
export const Duplikaattihaku : React.FC = () : React.ReactElement => {
    ...
    const { paketti, setPaketti, setSearchResults, searchResults, duplicates, setDuplicates, lisaPaketti, setLisaPaketti, setAvaus, avaus } = useContext(Context)
